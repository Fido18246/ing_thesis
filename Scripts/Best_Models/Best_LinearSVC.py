...
def cross_validation_LinearSVC(Xy_full_paths, X_clustered, y_clustered, output_path):
    """
...
def best_model(data_path_full, data_path_clustered, output_path, dir_name):
    """
    Perform cross-validation with LinearSVC model and save the results.
    ...
    cross_validation_LinearSVC(Xy_full_paths, X_clustered, y_clustered, output_path)
